        ...
        module(
            ...
            questions = listOf(
                question(
                    ...
                    options = listOf(
                        option("try_it", "Change the employee ID quickly to see if the system blocks you.", false, "This is the wrong choice. Testing another person's record without authorization may expose private data. OWASP A01 treats this as an access control risk."),
                ...
                question(
                    ...
                    options = listOf(
                        ...
                        option("use_once", "Use it once because the refund is urgent.", false, "Urgency does not justify bypassing access control. OWASP A01 focuses on preventing users from acting outside assigned permissions."),
        ...
        module(
            ...
            questions = listOf(
                question(
                    ...
                    options = listOf(
                        option("leave_it", "Leave it for now because the tool is only internal.", false, "Internal systems can still be reached by attackers or misused by insiders. Default credentials are a serious misconfiguration."),
                ...
                question(
                    ...
                    options = listOf(
                        option("screenshot_public", "Post the screenshot in a public team chat for quick help.", false, "Detailed errors can expose system internals. Posting them publicly widens the disclosure."),
            ...
            questions = listOf(
                question(
                    ...
                    options = listOf(
                        ...
                        option("install", "Install it because reviews suggest it is safe.", false, "Public reviews do not prove integrity or suitability for business data."),
                ...
                question(
                    ...
                    options = listOf(
                        option("merge_now", "Merge it quickly so the project stays up to date.", false, "Fast updates are useful, but unusual maintainers and new permissions require review."),
        ...
        module(
            ...
            questions = listOf(
                question(
                    ...
                    options = listOf(
                        option("public_link", "Upload it to the public link because the consultant needs it urgently.", false, "An unprotected public link can expose sensitive customer data."),
                ...
                question(
                    ...
                    options = listOf(
                        ...
                        option("use_vpn_only", "Use it only while connected to VPN and ignore the warning.", false, "VPN may reduce exposure, but the login page still lacks proper transport protection."),
            ...
            questions = listOf(
                question(
                    ...
                    options = listOf(
                        ...
                        option("paste", "Paste the text exactly as given to see whether it finds the record.", false, "Running suspicious input in production can expose or damage data."),
                ...
                question(
                    ...
                    options = listOf(
                        option("run_admin", "Run it as administrator so the fix has permission to work.", false, "This gives unknown code high privileges and may compromise the machine."),
        ...
        module(
            ...
            questions = listOf(
                question(
                    ...
                    options = listOf(
                        option("use_codes", "Use a few referral codes because the system allows it.", false, "This abuses a business logic flaw."),
                ...
                question(
                    ...
                    options = listOf(
                        ...
                        option("manual_spreadsheet", "Track suspected abuse manually at the end of each month.", false, "Manual after-the-fact review is weaker than designing preventive controls."),
                    ),
                ),
            ),
        ),
            ...
            questions = listOf(
                question(
                    ...
                    options = listOf(
                        ...
                        option("ignore", "Ignore the prompts and continue working.", false, "Repeated prompts may indicate an active account takeover attempt."),
                ...
                question(
                    ...
                    options = listOf(
                        ...
                        option("share_manager", "Ask your manager to store the password in case you forget it.", false, "Passwords should not be shared. Use approved password management."),
                    ),
                ),
            ),
        ),
        module(
            ...
            questions = listOf(
                question(
                    ...
                    options = listOf(
                        option("install", "Install it because performance problems affect business operations.", false, "Unsigned firmware can be malicious or modified."),
                ...
                question(
                    ...
                    options = listOf(
                        option("enable", "Enable macros because the prices are needed today.", false, "Macros can execute code and may be used to tamper with systems or data."),
            ...
            questions = listOf(
                question(
                    ...
                    options = listOf(
                        ...
                        option("disable_account", "Disable the account yourself without following the incident process.", false, "Containment should follow the approved incident process and preserve evidence."),
                ...
                question(
                    ...
                    options = listOf(
                        ...
                        option("disable_all", "Disable every export immediately and permanently.", false, "Temporary containment may be needed, but the best long-term fix is monitored, controlled exporting."),
            ...
            questions = listOf(
                question(
                    ...
                    options = listOf(
                        ...
                        option("retry_many", "Click retry several times until the transaction completes.", false, "Repeated retries can worsen partial transactions or duplicate processing."),
                ...
                question(
                    ...
                    options = listOf(
                        option("coordinate_chat", "Tell staff to coordinate in chat before approving refunds.", false, "Manual coordination is weak and does not fix the unsafe concurrent state."),
