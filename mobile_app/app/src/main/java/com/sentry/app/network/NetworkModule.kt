...
import com.sentry.app.network.interceptors.AuthInterceptor
...
object NetworkModule {
    ...
    @Provides @Singleton
    fun provideOkHttpClient(tokenManagerProvider: Provider<TokenManager>): OkHttpClient {
        ...
        return OkHttpClient.Builder()
            .addInterceptor(AuthInterceptor(tokenManagerProvider))
    ...
    @Provides @Singleton
    fun provideSentryApiService(retrofit: Retrofit): SentryApiService =
